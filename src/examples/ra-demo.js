async (page) => {
    ...
    // Fill input[name="q"]
    await Promise.all([
        page.waitForNavigation({ /* url: 'http://localhost:3000/#/customers?filter=%7B%22q%22%3A%22H%22%7D&order=DESC&page=1&perPage=25&sort=last_seen', */ waitUntil: 'networkidle' }),
        page.scrollToElement('input[name="q"]'),
